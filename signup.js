...
const supabaseKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InBqemxyYmphY3hldHVwdG50ZGZuIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjMyODYzODUsImV4cCI6MjA3ODg2MjM4NX0.n60koN_CiNOlXHknw-b8rbxb090-vz56wQEihQKc-Ps'; // ⚠️ use anon key
...
async function googleLogin() {
    const { data, error } = await supabase.auth.signInWithOAuth({
        ...
        options: {
            ...
            flowType: "pkce"  // MUST for Google login
        }
    });
